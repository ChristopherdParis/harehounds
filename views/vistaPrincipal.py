...
class VistaPrincipal:
    def __init__(self, root):
        ...
        #self.mensaje_label = tk.Label(root, text="hola", font=("Arial", 12))
        #self.mensaje_label.pack(pady=100)
        ...
        self.jugador_inicial = tk.IntVar()
        self.jugador_inicial.set(1) 

    def iniciar_juego(self):
        seleccion = self.jugador_inicial.get()
        print("Seleccion0", seleccion)
        if seleccion == 1:
            print("El juego inicia con los Perros.")
        elif seleccion == 2:
            print("El juego inicia con la Liebre.")
        else:
            print("No se seleccionó un jugador inicial.")
    ...
    def dibujar_conejo(self, posicion, texto="Conejo"):
        x, y = posicion
    ...
    def dibujar_tablero(self):
        ...
        ###########################################################################################
            ...
            # Crear un Frame principal para contener todo y agregarlo a root usando pack
        ...
        self.jugador_inicial = tk.StringVar(value="Hounds")  # Inicializa la variable

        # Radiobuttons para seleccionar quién se mueve primero
        self.radio_perros = tk.Radiobutton(self.frame_opciones, text="Perros", variable=self.jugador_inicial, value=1)
        self.radio_perros.grid(row=1, column=0)

        self.radio_liebre = tk.Radiobutton(self.frame_opciones, text="Liebre", variable=self.jugador_inicial, value=2)
        ...
        # Botón "New"
        self.boton_new = tk.Button(self.frame_botones, text="New", command=self.iniciar_juego)
        ...
        # Botón "Help"
        self.boton_help = tk.Button(self.frame_botones, text="Help", command=self.iniciar_juego)
